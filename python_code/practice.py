...
class Perceptron(object):
    ...
    def fit(self, X, y):
        ...
        # normal(loc=평균, scale=표준편차, size=몇개의 데이터를 뱉어줄까?) : 평균이 loc이고 표준편차가 scale인 정규분포(평균:0 분산:1) 데이터를 size만큼 뱉어 달라!
        print(self.w_) # 3개의 랜덤값 들어가 있다. '''[ 0.01624345 -0.00611756 -0.00528172]'''
        self.errors_ = []
